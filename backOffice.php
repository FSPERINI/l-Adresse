...
$db = new PDO('; dbname=speri1516488; charset=utf8', '', '');
                ...
                <div id="carte" class="menu bg-yellow">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div id="menu1">
                            ...
                            ?>
                            <div class="pb-2r">
                                <input class="input-back mb-1r" name="<?='titre'.(string) $count;?>" value="<?=$i['titre'];?>" placeholder="Titre du plat"> 
                                <textarea class="input-back mb-1r" name="<?='ingredients'.(string) $count;?>" rows="6"><?=$i['ingredients'];?></textarea>
                            </div>
                                <?php $count++;}?>
                                <input type="text" value="menu" name="bddSelector" class="hidden">
                                <input class="button-back mb-4r" type="submit" value="Mettre à jour">
                            </form>
                        </div>
                        ...
                        <div id="menu2" class="hidden">
                            ...
                            <div class="pb-2r">
                                ...
                                <input type="text" value="burgers" name="bddSelector" class="hidden">
                                <input class="button-back mb-4r" type="submit" value="Mettre à jour">
                            </form>
                        </div>
                        ...
                        <div id="menu3" class="hidden">
                            <form method="POST" action="editMenu.php">
                                ...
                                <input type="text" value="desserts" name="bddSelector" class="hidden">
                                <input class="button-back mb-4r" type="submit" value="Mettre à jour">
                            </form>
                        </div>
                        ...
                        <div id="menu4" class="hidden">
                            ...
                            <input type="text" value="vins" name="bddSelector" class="hidden">
                            <input class="button-back mb-4r" type="submit" value="Mettre à jour">
                        </form>
                    </div>
                    <a class="button-back" href="index">Revenir sur l'accueil</a>
                </div>
            </div>
        </div>
